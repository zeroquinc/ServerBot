...
async def system_info():
    try:
        ...
        embed.add_field(name="Uptime :stopwatch:", value=uptime, inline=True)
        embed.add_field(name="Load :scales:", value=load, inline=True)
        embed.add_field(name="Users :busts_in_silhouette:", value=users, inline=True)
        embed.add_field(name="Total Space :minidisc:", value=storage_total, inline=True)
        embed.add_field(name="Used Space :rocket:", value=storage_used, inline=True)
        embed.add_field(name="Free Space :milky_way:", value=storage_free, inline=True)
        embed.add_field(name="CPU Temp :fire:", value=f"{cpu_temp}°C", inline=True)
        embed.add_field(name="CPU Usage :desktop:", value=f"{cpu_usage}% [{cpu_ghz}]", inline=True)
        embed.add_field(name="RAM Usage :ram: ", value=f"{ram_usage}% [{total_ram}]", inline=True)
        embed.add_field(name="Network RX :arrow_down:", value=rx, inline=True)
        embed.add_field(name="Network TX :arrow_up:", value=tx, inline=True)
        embed.add_field(name="Total Data :bar_chart:", value=total, inline=True)
        embed.add_field(name="Packages :package:", value=package_updates, inline=False)
        embed.add_field(name="Info :loudspeaker:", value=generation_info, inline=False)
