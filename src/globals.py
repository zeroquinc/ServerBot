...
# RetroAchievements Channels
CHANNEL_ACHIEVEMENTS = int(os.getenv("CHANNEL_ACHIEVEMENTS"))
CHANNEL_MASTERED = int(os.getenv("CHANNEL_MASTERED"))
CHANNEL_RETRO_OVERVIEW = int(os.getenv("CHANNEL_RETRO_OVERVIEW"))
